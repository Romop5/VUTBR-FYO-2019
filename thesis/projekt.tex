...
\projectinfo{
  ...
  title.cs={Aberace čoček},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Lens aberration}, % název práce v angličtině / thesis title in english
  %title.length={14.5cm}, % nastavení délky bloku s titulkem pro úpravu zalomení řádku (lze definovat zde nebo níže) / setting the length of a block with a thesis title for adjusting a line break (can be defined here or below)
  %Autor / Author
  author.name={Roman},   % jméno autora / author name
  author.surname={Dobiáš},   % příjmení autora / author surname 
  ...
  keywords.cs={Aberácie, sférická aberácia, astigmatizmus, coma, chromatická aberácia}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  ...
  % Abstrakt / Abstract
  abstract.cs={Cieľom tejto práce je poskytnúť čitateľovi základný prehľad o optických aberáciach,
  ich prejavoch a možnosti ich riešenia. Súčasťou práce je edukatívna aplikácia, ktorá umožňuje
  záujemcom experimentovať s nastavením optickej sústavy a ovplyvniť tak vznik jednotlivých aberácii
  pri šírení ľúčov systémom.}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
