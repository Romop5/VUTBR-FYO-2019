...
tendenciu stretnúť v jednej línii. Dôsledkom je potom pri zobrazení bodu rozmazaný typický obraz, ktorého
tvar pripomína kométu.
\begin{figure}[h]
    \label{comaDescribe}
\includegraphics[scale=0.15]{obrazky-figures/coma.png}
\includegraphics[scale=0.35]{obrazky-figures/coma.jpg}
    \centering \caption{Vľavo: dopad paralelných ľúčov pod uhlom spôsobuje }
\end{figure}
